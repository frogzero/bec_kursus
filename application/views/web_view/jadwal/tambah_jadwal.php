              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="well bs-component">
                    <form class="form-horizontal" method="POST" action="<?=site_url('admin/jadwal/simpan_jadwal')?>"> 
                      <fieldset>
                        <legend>Form</legend>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                           <select class="form-control" id="demoSelect" name="instruktur">
                            <?php foreach ($tampil_instruktur as $row): ?>
                               <option value="<?=$row->id_instruktur?>"><?=$row->nama_instruktur?></option> 
                            <?php endforeach ?>
                                                              
                              </select>
                           </div>
                        </div>
                        <input type="text" name="id_kelas" placeholder="ex: 20:00" hidden="true" value="<?=$id_kelas?>" >
                          <!--   <div class="form-group">
                        ...
                        -->
                         <div class="form-group">
                          ...
                          <div class="col-lg-10">
                           <input class="form-control" name="jam"  type="text" placeholder="ex: 20:00">
                           </div>
                        </div>
