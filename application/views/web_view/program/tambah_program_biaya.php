              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="well bs-component">
                    <form class="form-horizontal" method="POST" action="<?=site_url('admin/program/simpan_program')?>"> 
                      <fieldset>
                        <legend>Form</legend>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input class="form-control" name="biaya_program"  type="number" placeholder="biaya">
                          </div>
                        </div>
